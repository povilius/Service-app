...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const businesses = yield Business.find();
        res.json(businesses);
    }
    catch (err) {
...
router.post('/', authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const categoryExists = yield Category.findOne({ name: business.category });
        if (!categoryExists) {
...
router.get('/category/:category', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const filteredBusinesses = yield Business.find({
...
router.get('/:id/bookings/date/:date', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const slots = yield Booking.find({
